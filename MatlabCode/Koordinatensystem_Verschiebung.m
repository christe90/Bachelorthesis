function Abbildungsmatrix = Koordinatensystem_Verschiebung(Y_Vektoren, Z_Vektoren, i_Kollisions_koerper, i_Shell)
...
Abbildungsmatrix(:,2) = cross(Abbildungsmatrix(:,3), Abbildungsmatrix(:,1));
